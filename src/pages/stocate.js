        ...
        <div className="container flex flex-col gap-y-24 py-24">
          ...
          <div className="flex flex-col max-w-xl gap-y-2 md:px-12">
            ...
            <div className="h3">
              ...
              recommendations for locally and sustainably sourced products and
          ...
          <div className="flex flex-col max-w-xl gap-y-2 md:px-12">
            ...
            <div className="h3">
              ...
              through the product and development teams.
            </div>
            <div className="h3">
            ...
            <div className="h3">
              ...
              following design solutions, and design systems I built during my
              internship.
            </div>
          </div>
          ...
          <div className="flex flex-col max-w-xl gap-y-2 md:px-12">
            ...
            <div className="h3">
              In order to improve our active user numbers, we wanted to
              strengthen our core features so that users have a reason to come
              back. This is why generating design solutions for user problems
              within the mobile application was one of my main tasks at Stocate.
              To improve a core feature, I went through the steps of conducting
          ...
          <div className="flex flex-col max-w-xl gap-y-2 md:px-12">
            ...
            <div className="h3">
              ...
              so we could prioritize them when building solutions. We decided to
          ...
          <div className="flex flex-col max-w-xl gap-y-2 md:px-12">
            ...
            <div className="h3">
              ...
              of the desktop and mobile application. We brainstormed by asking
              "How might we?" questions and discussed potential solution routes
              to take. We were able to narrow our core problems to specific
              users journeys in the application that needed improvement. The
              user flows we planned to improve were: Onboarding, Adding stores,
              Adding items, Creating lists, Messaging system, & Transactions
              system.
            </div>
          </div>
          ...
          <div className="flex flex-col max-w-xl gap-y-2 md:px-12">
            ...
            <div className="h3">
              ...
              sustainability incorporated in their everyday life. B) Their
              general thoughts on the interface and experience, likes and
              dislikes. C) Features they would like to see in a sustainability
              application.
            </div>
          </div>
          ...
          <div className="flex flex-col max-w-xl gap-y-2 md:px-12">
            ...
            <div className="h3">
              ...
              process we used for creating design solutions was the Agile sprint
          ...
          <div className="flex flex-col max-w-xl gap-y-2 md:px-12">
            ...
            <div className="h3">
              ...
              the second section, I would ask users to complete a scenario in
              the application and walk me through their experience with our
              Figma prototype. Scenarios were things like:{" "}
              <span className="italic">
                {" "}
                You're doing your regular grocery shop. Try finding and adding
                items to your shopping list.{" "}
              </span>
              During this portion, I am able to focus in on roadblocks users
              have during specific areas of the application. Conducting
              interviews and completing scenarios in the application provided us
          ...
          <div className="w-full h-full">
            <img
              className="object-contain mx-auto h-full w-1/3 rounded-sm"
              src={Testing}
              alt="Image"
            />
          </div>
          ...
          <div className="flex flex-col max-w-xl gap-y-2 md:px-12">
            ...
            <div className="h3">
              These are a iterations done for the fixed search bar component.
              The fixed search bar solved the problem users were having of
