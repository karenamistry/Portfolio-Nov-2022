...
function ProjectContainer() {
  return (
    <div className="bg-gray-100 w-screen py-24 ">
        ...
        <div className="flex flex-col gap-y-24 md:flex-row md:gap-y-0 md:gap-x-6">
          ...
          >
            <div className="flex flex-col gap-y-6" href="#">
              <div className="flex flex-col gap-y-2">
                <div className="flex flex-col">
                  <div className="h2">Feature - Case Study</div>
                  <div className="h5 max-w-md pb-2">2020</div>
                </div>
          ...
          >
            <div className="flex flex-col gap-y-6" href="#">
              <div className="flex flex-col gap-y-2">
                <div className="flex flex-col">
                  <div className="h2">Tablature - Case Study</div>
